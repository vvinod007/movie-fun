...
public class AlbumsController {
    ...
    public HttpEntity<byte[]> getCover(@PathVariable long albumId) throws IOException, URISyntaxException {
        ...
        Blob coverBlob = maybeCoverBlob.orElseGet(this::buildDefualtCoverBlob);
    ...
    private Blob buildDefualtCoverBlob(){
        ClassLoader classLoader = getClass().getClassLoader();
        InputStream input = classLoader.getResourceAsStream("defualt-cover.jpg");

        return new Blob("defualt-cover", input, IMAGE_JPEG_VALUE);
    }
